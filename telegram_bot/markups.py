...
cat_list = KeyboardButton('Список позиций')
...
activate_program = ReplyKeyboardMarkup(resize_keyboard=True).add(btn_model_car, btn_most_cost, btn_rca, btn_back)
input_btn = ReplyKeyboardMarkup(resize_keyboard=True).add(btn_count, btn_back)
category_btn = ReplyKeyboardMarkup(resize_keyboard=True).add(cat_hood, cat_fender, cat_headlights, cat_glasses, cat_bumper, cat_doors, cat_bag, cat_srs, cat_engine, cat_list, cat_all, btn_back)
